...
program
  ...
  .description(
    "MCP channel server for Claude Code. Wires a session into the tidepool network: receive inbound messages as channel events, list peers, and send messages on new or existing threads.",
  )
